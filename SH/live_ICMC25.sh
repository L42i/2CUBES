...
tmux split-window -h -t 2CUBES
tmux send-keys -t 2CUBES 'aj-snapshot -x -d ../setup/ICMC25.snap' C-m


tmux split-window -h -t 2CUBES
tmux send-keys -t 2CUBES 'reaper' C-m

tmux split-window -h -t 2CUBES
tmux send-keys -t 2CUBES 'jacktrip -C 10.11.12.100 -n 32 -J TO_SPEAKERS' C-m
